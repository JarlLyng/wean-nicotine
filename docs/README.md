...
| Tapering formula                  | `lib/taper-plan.ts`                              | Allowance math, whole-pouch display floor (`getDisplayAllowance`), weeks-to-zero estimate. Use code for exact rounding/clamping.                                                                                                                                        |
| Progress, milestones & insights   | `lib/progress.ts`                                | Weekly/total progress, milestone day-walk, usage patterns, pace assessment.                                                                                                                                                                                             |
| Shared constants / tunables       | `lib/constants.ts`                               | Pouches-per-can, milestone thresholds, notification/pace-nudge/review-prompt knobs.                                                                                                                                                                                     |
| In-app review prompt              | `lib/store-review.ts`                            | Gate logic (plan age, frequency, availability) for `expo-store-review`.                                                                                                                                                                                                 |
